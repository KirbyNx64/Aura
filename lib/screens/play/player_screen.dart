              ...
              return ValueListenableBuilder<AppColorScheme>(
                ...
                builder: (context, colorScheme, _) {
                  ...
                  return SlidingUpPanel(
                    ...
                    body: Stack(
                      children: [
                        // Capa base negra opaca (siempre visible)
                        if (showBackground)
                          const Positioned.fill(
                            child: ColoredBox(color: Colors.black),
                          ),
                        // Fondo con carátula y gradiente (con animación de opacidad)
                        if (showBackground)
                          widget.panelPositionNotifier != null
                              ? ValueListenableBuilder<double>(
                                  ...
                                  builder: (context, position, _) {
                                    return Opacity(
                                      opacity: ((position - 0.7) / 0.3).clamp(
                                        0.0,
                                        1.0,
                                      ),
                                      child: Stack(
                                          ...
                                          return LayoutBuilder(
                                            builder: (context, constraints) {
                                              ...
                                              final double iconSize =
                                                  (maxControlsWidth / 400 * 44)
                                                      .clamp(34, 60);
                                              final double sideIconSize =
                                                  (maxControlsWidth / 400 * 56)
                                                      .clamp(42, 76);
                                              final double mainIconSize =
                                                  (maxControlsWidth / 400 * 76)
                                                      .clamp(60, 100);
                                              final double playIconSize =
                                                  (maxControlsWidth / 400 * 52)
                                                      .clamp(40, 80);
