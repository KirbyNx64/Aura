...
const Map<String, String> appLocalizationsEn = {
  ...
  'to': 'to',
  'lets_go': 'Let\'s Go!',
  'onboarding_setup_desc': 'Let\'s get everything set up for you.',
  'welcome_title': 'Welcome to Aura Music',
  'welcome_desc': 'Enjoy your local music with the best experience.',
  'get_started': 'Get Started',
  'step_of': 'Step {current} of {total}',
  'permissions_title': 'Permissions required',
  'media_permission': 'Media Permission',
  'grant_media_permission': 'Grant Media Permission',
  'permissions_desc': 'To play your music, we need access to your audio files.',
  'notifications_active': 'Notifications Active',
  'optimization_ignored': 'Optimization Ignored',
  'cancel': 'Cancel',
  ...
  'all_set_desc':
      'You have completed the initial setup. You can now start enjoying Aura Music.',
  'notifications_title': 'Notifications',
  'notifications_desc': 'Allow Aura Music to show song download notifications.',
  'battery_optimization_onboarding_title': 'Background playback',
  'battery_optimization_onboarding_desc':
      'To prevent the music from stopping when the app is in the background, we need to ignore battery optimization.',
  ...
  'error_loading_video': 'Could not load video',
  'mode_song': 'Song',
  'mode_video': 'Video',
  'equalizer': 'Equalizer',
  ...
  'audio_quality_streaming': 'Streaming audio quality',
  'audio_quality_streaming_desc':
      'Choose the audio quality when streaming music',
  'stream_audio_cache': 'Streaming audio cache',
  'stream_audio_cache_desc':
      'Saves songs to disk while listening for instant playback next time without using data.',
  'stream_audio_cache_limit': 'Audio cache limit',
  'stream_audio_cache_no_limit': 'No limit',
  'stream_audio_cache_disabled': 'Disabled',
  'stream_audio_cache_used': '{used} of {limit}',
  'stream_audio_cache_clear': 'Clear cache',
  'stream_audio_cache_cleared': 'Cache cleared',
  'stream_audio_cache_cleared_desc':
      'All songs stored in the streaming cache have been deleted.',
  'audio_quality_high': 'High quality',
  'audio_quality_high_desc': 'Best available quality (larger size)',
  'audio_quality_streaming_high_desc': 'Best quality (higher bitrate)',
  ...
  'lyrics_service_desc': 'Choose the service to fetch song lyrics',
  ...
  'dynamic_theme_warning':
      'This theme is experimental, you may experience slowness in the app',
  'app_description':
  ...
  'monthly_audience_label': 'Monthly audience:',
  ...
  'recent': 'Recent',
  'playlists': 'Playlists',
  'yt_auto_generated_playlist': 'Auto-generated playlist',
  ...
  'update': 'Update',
  'login': 'Login',
  'yt_music_login': 'YouTube Account',
  'yt_music_login_desc': 'Connect your account to view your library playlists',
  'yt_music_loading_session': 'Loading session...',
  'yt_music_session_active': 'Signed in',
  'yt_music_session_saved': 'YouTube session saved',
  'yt_music_session_removed': 'YouTube session removed',
